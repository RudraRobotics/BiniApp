...
function mapImgTapped() {
    ...
    if(enable_way_pnts && MyScript.sprite.length === 0) {
        MyScript.createDynamicWayPntItem(tapArea.point.position.x, tapArea.point.position.y, "../images/loc.png", 'Base')
//        dynamicWayPntListModel.append({"sprite_item": MyScript.sprite[MyScript.sprite.length - 1]})
        ...
        MyScript.createDynamicWayPntItem(tapArea.point.position.x, tapArea.point.position.y, "../images/loc.png", 'Location'+i)
//        dynamicWayPntListModel.append({"sprite_item": MyScript.sprite[MyScript.sprite.length - 1]})
    }
    objCreated()
}
